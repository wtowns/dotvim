...
if !exists('g:HemisuTransparentBackground')
	let g:HemisuTransparentBackground = 0
endif
...
if &background=="dark"
	" Dark theme
	if g:HemisuTransparentBackground
		let s:bg=s:transparent
	else
		let s:bg=s:black
	endif
...
let &background = s:orig_background
